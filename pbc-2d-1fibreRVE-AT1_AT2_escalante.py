...
n = p.nodes
# define edge sets
NodesEdgeAB = n.getByBoundingBox(-tol,tol,-tol,
                                  tol,side-tol,tol)
p.Set(nodes=NodesEdgeAB, name='SetEgdeAB')

NodesEdgeDC = n.getByBoundingBox(side-tol,tol,-tol,
                                 side+tol,side-tol,tol)
p.Set(nodes=NodesEdgeDC, name='SetEgdeDC')

NodesEdgeAD = n.getByBoundingBox(tol,    -tol,-tol,
                                 side-tol,tol,tol)
p.Set(nodes=NodesEdgeAD, name='SetEgdeAD')

NodesEdgeBC = n.getByBoundingBox(tol,     side-tol,-tol,
                                 side-tol,side+tol,tol)
p.Set(nodes=NodesEdgeBC, name='SetEgdeBC')

NodesVertA = n.getByBoundingBox(-tol,-tol,-tol,
                                 tol,tol,tol)
p.Set(nodes=NodesVertA, name='SetVertA')

NodesVertD = n.getByBoundingBox(side-tol,-tol,-tol,
                                side+tol,tol,tol)
p.Set(nodes=NodesVertD, name='SetVertD')

NodesVertC = n.getByBoundingBox(side-tol,side-tol,-tol,
                                side+tol,side+tol,tol)
p.Set(nodes=NodesVertC, name='SetVertC')

NodesVertB = n.getByBoundingBox(-tol,side-tol,-tol,
                                 tol,side+tol, tol)
...
for i in range(length1):
	...
	mdb.models[Model_Name].Equation(name=pfconstraintname, 
        terms=((1.0, Set1, 3), (-1.0, Set2, 3), (-1.0, 'Part-1-1.SetVertA', 3), (1.0, 'Part-1-1.SetVertD', 3)))	
...
for i in range(length1):
	...
	mdb.models[Model_Name].Equation(name=pfconstraintname, 
        terms=((1.0, Set1, 3), (-1.0, Set2, 3), (-1.0, 'Part-1-1.SetVertA', 3), (1.0, 'Part-1-1.SetVertB', 3)))
