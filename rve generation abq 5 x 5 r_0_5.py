...
s = mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=30) 
...
s1 = mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=30) 
...
s = mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=5*h) 
g, v, d, c = s.geometry, s.vertices, s.dimensions, s.constraints 
s.setPrimaryObject(option=SUPERIMPOSE) 
p = mdb.models['Model-1'].parts['Part-1'] 
p.projectReferencesOntoSketch(sketch=s, filter=COPLANAR_EDGES) 
s.rectangle(point1=(0 ,0), point2=(h , w)) 
s.rectangle(point1=(-2*h ,-2*w), point2=(2*h ,2*w)) 
